...
public class JPAJuicioDao extends JPAGenericDao<Juicio, Integer> implements JuicioDao {
    ...
    public List<Juicio> tipoJuicio1() {
        ...
        try {
            String consulta = "select count (nr_codigo) from juicio where nr_codigo = 1 and upper (ju_estado_juicio) like '%ACTIV%'"
                    + "and ta_codigo = 1";
    ...
    public List<Juicio> tipoJuicio2() {
        List tiposJuicios1 = null;
        try {
            String consulta = "select count (nr_codigo) from juicio where nr_codigo = 2 and upper (ju_estado_juicio) like '%ACTIV%'"
                    + "and ta_codigo = 1";
            Query query = em.createNativeQuery(consulta);
            tiposJuicios1 = query.getResultList();
            //return tiposJuicios1;
    ...
    public List<Juicio> tipoJuicio3() {
        List tiposJuicios1 = null;
        try {
            String consulta = "select count (nr_codigo) from juicio where nr_codigo = 3 and upper (ju_estado_juicio) like '%ACTIV%'"
                    + "and ta_codigo = 1";
            Query query = em.createNativeQuery(consulta);
            tiposJuicios1 = query.getResultList();
            //return tiposJuicios1;
    ...
    public List<Juicio> tipoJuicio4() {
        List tiposJuicios1 = null;
        try {
            String consulta = "select count (nr_codigo) from juicio where nr_codigo = 4 and upper (ju_estado_juicio) like '%ACTIV%'"
                    + "and ta_codigo = 1";
            Query query = em.createNativeQuery(consulta);
            tiposJuicios1 = query.getResultList();
            //return tiposJuicios1;
    ...
    public List<Juicio> tipoJuicio5() {
        List tiposJuicios1 = null;
        try {
            String consulta = "select count (nr_codigo) from juicio where nr_codigo = 5 and upper (ju_estado_juicio) like '%ACTIV%'"
                    + "and ta_codigo = 1";
            Query query = em.createNativeQuery(consulta);
            tiposJuicios1 = query.getResultList();
            //return tiposJuicios1;
 ...
 /*Método que consulta Acciones Constitucionales y nivel 1"*/
    ...
    public List<Juicio> InJuiAccCons() {
        ...
        try {
            String consulta = "select count (ta_codigo) from juicio where ta_codigo = 1 and upper(ju_ocacionado) like '%BANECUADOR%' and upper (ju_estado_juicio) like '%ACTIV%'";
            Query query = em.createNativeQuery(consulta);
    ...
    public List<Juicio> InJuiCiviles() {
        List tiposJuicios = null;
        try {
            String consulta = "select count (ta_codigo) from juicio where ta_codigo = 2 and upper(ju_ocacionado) like '%BANECUADOR%' and upper (ju_estado_juicio) like '%ACTIV%'";
            Query query = em.createNativeQuery(consulta);
            tiposJuicios = query.getResultList();
            //return tiposJuicios1;
        } catch (Exception e) {
    ...
    public List<Juicio> InJuiContenciosos() {
        List tiposJuicios = null;
        try {
            String consulta = "select count (ta_codigo) from juicio where ta_codigo = 3 and upper(ju_ocacionado) like '%BANECUADOR%' and upper (ju_estado_juicio) like '%ACTIV%'";
            Query query = em.createNativeQuery(consulta);
            tiposJuicios = query.getResultList();
            //return tiposJuicios1;
        } catch (Exception e) {
    ...
    public List<Juicio> InJuiLaborales() {
        List tiposJuicios = null;
        try {
            String consulta = "select count (ta_codigo) from juicio where ta_codigo = 4 and upper(ju_ocacionado) like '%BANECUADOR%' and upper (ju_estado_juicio) like '%ACTIV%'";
            Query query = em.createNativeQuery(consulta);
            tiposJuicios = query.getResultList();
            //return tiposJuicios1;
        } catch (Exception e) {
    ...
    public List<Juicio> InJuiPenales() {
        List tiposJuicios = null;
        try {
            String consulta = "select count (ta_codigo) from juicio where ta_codigo = 5 and upper(ju_ocacionado) like '%BANECUADOR%' and upper (ju_estado_juicio) like '%ACTIV%'";
            Query query = em.createNativeQuery(consulta);
            tiposJuicios = query.getResultList();
            //return tiposJuicios1;
        } catch (Exception e) {
    ...
    public List<Juicio> InJuitramEspec() {
        List tiposJuicios = null;
        try {
            String consulta = "select count (ta_codigo) from juicio where ta_codigo = 6 and upper(ju_ocacionado) like '%BANECUADOR%' and upper (ju_estado_juicio) like '%ACTIV%'";
            Query query = em.createNativeQuery(consulta);
            tiposJuicios = query.getResultList();
            //return tiposJuicios1;
        } catch (Exception e) {
    ...
    public List<Juicio> InJuiTotalCB() {
        List tiposJuicios = null;
        try {
            String consulta = "select count (ju_ocacionado) from juicio where upper(ju_ocacionado) like '%BANECUADOR%' and upper (ju_estado_juicio) like '%ACTIV%'";
            Query query = em.createNativeQuery(consulta);
            tiposJuicios = query.getResultList();
            //return tiposJuicios1;
        } catch (Exception e) {
    ...
    public List<Juicio> InJuiAccConsCC() {
        List tiposJuicios = null;
        try {
            String consulta = "select count (ju_cuantia) from juicio where upper(ju_cuantia) not like '%INDETERMINAD%' and ta_codigo = 1 and upper (ju_estado_juicio) like '%ACTIV%'";
            Query query = em.createNativeQuery(consulta);
            tiposJuicios = query.getResultList();
            //return tiposJuicios1;
        } catch (Exception e) {
    ...
    public List<Juicio> InJuiJuiCivilesCC() {
        List tiposJuicios = null;
        try {
            String consulta = "select count (ju_cuantia) from juicio where upper(ju_cuantia) not like '%INDETERMINAD%' and ta_codigo = 2 and upper (ju_estado_juicio) like '%ACTIV%'";
            Query query = em.createNativeQuery(consulta);
            tiposJuicios = query.getResultList();
            //return tiposJuicios1;
        } catch (Exception e) {
    ...
    public List<Juicio> InJuiJuiContenciososCC() {
        List tiposJuicios = null;
        try {
            String consulta = "select count (ju_cuantia) from juicio where upper(ju_cuantia) not like '%INDETERMINAD%' and ta_codigo = 3 and upper (ju_estado_juicio) like '%ACTIV%'";
            Query query = em.createNativeQuery(consulta);
            tiposJuicios = query.getResultList();
            //return tiposJuicios1;
        } catch (Exception e) {
    ...
    public List<Juicio> InJuiJuiLaboralesCC() {
        List tiposJuicios = null;
        try {
            String consulta = "select count (ju_cuantia) from juicio where upper(ju_cuantia) not like '%INDETERMINAD%' and ta_codigo = 4 and upper (ju_estado_juicio) like '%ACTIV%'";
            Query query = em.createNativeQuery(consulta);
            tiposJuicios = query.getResultList();
            //return tiposJuicios1;
        } catch (Exception e) {
    ...
    public List<Juicio> InJuiJuiPenalesCC() {
        List tiposJuicios = null;
        try {
            String consulta = "select count (ju_cuantia) from juicio where upper(ju_cuantia) not like '%INDETERMINAD%' and ta_codigo = 5 and upper (ju_estado_juicio) like '%ACTIV%'";
            Query query = em.createNativeQuery(consulta);
            tiposJuicios = query.getResultList();
            //return tiposJuicios1;
        } catch (Exception e) {
    ...
    /*Inventario de Juicios - Juicios Penales sin Cuantia*/
    @Override
    public List<Juicio> InJuiTramEspecialesCC() {
        List tiposJuicios = null;
        try {
            String consulta = "select count (ju_cuantia) from juicio where upper(ju_cuantia) not like '%INDETERMINAD%' and ta_codigo = 6 and upper (ju_estado_juicio) like '%ACTIV%'";
            Query query = em.createNativeQuery(consulta);
            tiposJuicios = query.getResultList();
            //return tiposJuicios1;
        } catch (Exception e) {
    ...
    public List<Juicio> InJuiTotalJuiciosCC() {
        List tiposJuicios = null;
        try {
            String consulta = "select count (ju_cuantia) from juicio where upper(ju_cuantia) not like '%INDETERMINAD%' and upper (ju_estado_juicio) like '%ACTIVO%'";
            Query query = em.createNativeQuery(consulta);
            tiposJuicios = query.getResultList();
            //return tiposJuicios1;
        } catch (Exception e) {
    ...
    public List<Juicio> InJuiAccConsSC() {
        List tiposJuicios = null;
        try {
            String consulta = "select count (ju_cuantia) from juicio where upper(ju_cuantia) like '%INDETERMINAD%' and ta_codigo = 1 and upper (ju_estado_juicio) like '%ACTIV%'";
            Query query = em.createNativeQuery(consulta);
            tiposJuicios = query.getResultList();
            //return tiposJuicios1;
        } catch (Exception e) {
    ...
    public List<Juicio> InJuiJuiCivilesSC() {
        List tiposJuicios = null;
        try {
            String consulta = "select count (ju_cuantia) from juicio where upper (ju_cuantia) like '%INDETERMINAD%' and ta_codigo = 2 and upper (ju_estado_juicio) like '%ACTIV%'";
            Query query = em.createNativeQuery(consulta);
            tiposJuicios = query.getResultList();
            //return tiposJuicios1;
        } catch (Exception e) {
    ...
    public List<Juicio> InJuiJuiContenciososSC() {
        List tiposJuicios = null;
        try {
            String consulta = "select count (ju_cuantia) from juicio where upper (ju_cuantia) like '%INDETERMINAD%' and ta_codigo = 3 and upper (ju_estado_juicio) like '%ACTIV%'";
            Query query = em.createNativeQuery(consulta);
            tiposJuicios = query.getResultList();
            //return tiposJuicios1;
        } catch (Exception e) {
    ...
    public List<Juicio> InJuiJuiLaboralesSC() {
        List tiposJuicios = null;
        try {
            String consulta = "select count (ju_cuantia) from juicio where upper (ju_cuantia) like '%INDETERMINAD%' and ta_codigo = 4 and upper (ju_estado_juicio) like '%ACTIV%'";
            Query query = em.createNativeQuery(consulta);
            tiposJuicios = query.getResultList();
            //return tiposJuicios1;
        } catch (Exception e) {
    ...
    public List<Juicio> InJuiJuiPenalesSC() {
        List tiposJuicios = null;
        try {
            String consulta = "select count (ju_cuantia) from juicio where upper (ju_cuantia) like '%INDETERMINAD%' and ta_codigo = 5 and upper (ju_estado_juicio) like '%ACTIV%'";
            Query query = em.createNativeQuery(consulta);
            tiposJuicios = query.getResultList();
            //return tiposJuicios1;
        } catch (Exception e) {
    ...
    public List<Juicio> InJuiTramEspecialesSC() {
        List tiposJuicios = null;
        try {
            String consulta = "select count (ju_cuantia) from juicio where upper (ju_cuantia) like '%INDETERMINAD%' and ta_codigo = 6 and upper (ju_estado_juicio) like '%ACTIV%'";
            Query query = em.createNativeQuery(consulta);
            tiposJuicios = query.getResultList();
            //return tiposJuicios1;
        } catch (Exception e) {
    ...
    public List<Juicio> InJuiTotalJuiciosSC() {
        List tiposJuicios = null;
        try {
            String consulta = "select count (ju_cuantia) from juicio where upper (ju_cuantia) like '%INDETERMINAD%' and upper (ju_estado_juicio) like '%ACTIV%'";
            Query query = em.createNativeQuery(consulta);
            tiposJuicios = query.getResultList();
            //return tiposJuicios1;
        } catch (Exception e) {
